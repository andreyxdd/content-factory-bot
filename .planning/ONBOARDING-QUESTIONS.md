...
|---|----------------|---------|
| 1 | `primary_language` | Bot UI + draft language (`en` / `ru`) |
...
| 13 | `web_research` | Default **web research** at `/new` → `research_default_enabled` |
| 14 | `review_agent` | Default **review step** → `review_enabled` |
